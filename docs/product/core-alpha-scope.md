...
|  39 | **Open**        | Provider/model failure and no-fallback paths passed, but no `OPENAI_API_KEY` was available for the required authenticated OpenCode Zen smoke.                                         |
