...
|   6 | **Open**        | Clean `npm ci` and local `npm run verify` passed; a hosted run of the committed CI workflow is still unavailable.                                                                     |
