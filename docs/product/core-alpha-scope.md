...
10. Aptiloop includes no bundled Course. A fresh profile starts with an empty Course library and explicit Create Course / Import Course Pack actions; development fixtures are not release content.
...
- optional first-party/sample Courses after separate provenance, quality, safety, licensing, and ownership gates.
...
|  18 | Passed locally        | Focused kernel, shared-contract, API, and UI tests cover due reason, prior-evidence provenance, typed participation completion, exact-cycle retention, and deterministic successor scheduling. No source-session shortcut is fabricated.                        |
...
|  39 | Working-tree evidence | A fresh authenticated OpenCode Zen Tutor request was observed on the production-readiness working tree. It is not transferable to commit `b542b32`, does not cover every role/recovery path, and is not release authorization.                                  |
|  40 | Passed locally        | Provider/auth/model/tool failure suites remained explicit and never selected Mock.                                                                                                                                                                              |
|  41 | Passed locally        | Learning activities, including due-Review participation, have typed executors and manual paths that do not require AI.                                                                                                                                          |
...
|  46 | Passed locally        | Course Pack validation, temporary intake recovery, learner-safe Preview, atomic install/open-as-draft, immutable source/personal lineage, canonical export, active-session Course deletion rejection, immutable evidence retention, and rollback suites passed. |
