...
| `LEARNING_DESIGN`     | Persist target capability, observable evidence, practice, feedback, instruction/review, and explicit assumptions before proposal generation.                                                                                                |
