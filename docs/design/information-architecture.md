...
| `/settings/developer-tools`                                                           | Local provider and execution-boundary diagnostics                                                                                       | `apps/web/app/settings/developer-tools/page.tsx`                                                 | Secondary diagnostics do not define product IA.                                                               |
...
The former standalone `/chat` Agent Playground is retired. Tutor interaction belongs to an exact active lesson activity; Interview, Reviewer, and Course Designer use their dedicated bounded workflows rather than a generic role switcher.
