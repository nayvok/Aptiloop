...
| [0011](0011-collision-safe-install-port-selection.md)      | Collision-safe install port selection      | **Approved Core Alpha target**, 2026-09-09 |
| [0012](0012-course-transfer-scope-and-version-contract.md) | Course transfer scope and version contract | **Approved Core Alpha target**, 2026-09-09 |
