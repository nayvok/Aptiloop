...
Commit: `feat(web): add learning blocks and learner labels`.
...
Commit: `refactor: simplify learning path`.
...
Commit: `refactor: simplify learner terminology`.
...
Commit: `fix: resolve ux regressions` (по необходимости).
