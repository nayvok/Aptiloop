...
const enUS = {
  ...
  "mistakes.empty.description":
    "Explanations, quizzes, and checked solutions can create a correction with a review date.",
  "mistakes.repeated": "Repeated",
  "mistakes.previous": "Previous thinking",
  "mistakes.correction": "Correction",
  "mistakes.cause": "Cause: {cause}",
  "cards.loading": "Loading cards…",
  "cards.unavailable": "Cards are unavailable",
  "cards.empty.title": "No card candidates yet",
  "cards.empty.description":
    "Candidates appear after evidence-producing activities. Aptiloop never approves them automatically.",
  "cards.status.candidate": "Needs review",
  "cards.status.approved": "Approved",
  "cards.status.rejected": "Rejected",
  "cards.question": "Question",
  "cards.answer": "Answer",
  "cards.approve": "Approve card",
  "cards.reject": "Reject card",
  "cards.saveError": "Could not save the card status.",
...
const ruRU: Record<MessageKey, string> = {
  ...
  "mistakes.empty.description":
    "Объяснения, квизы и проверенные решения могут создать исправление с датой повторения.",
  "mistakes.repeated": "Повторилась",
  "mistakes.previous": "Как я думал",
  "mistakes.correction": "Исправление",
  "mistakes.cause": "Причина: {cause}",
  "cards.loading": "Загружаю карточки…",
  "cards.unavailable": "Карточки недоступны",
  "cards.empty.title": "Кандидатов пока нет",
  "cards.empty.description":
    "Кандидаты появляются после активностей с подтверждениями. Aptiloop не одобряет их автоматически.",
  "cards.status.candidate": "Нужна проверка",
  "cards.status.approved": "Подтверждена",
  "cards.status.rejected": "Отклонена",
  "cards.question": "Вопрос",
  "cards.answer": "Ответ",
  "cards.approve": "Подтвердить карточку",
  "cards.reject": "Отклонить карточку",
  "cards.saveError": "Не удалось сохранить статус карточки.",
