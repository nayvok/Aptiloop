...
const enUS = {
  ...
  "home.loadingCourses": "Checking your local Courses…",
  "home.unavailable": "Aptiloop Core is unavailable.",
  "home.coursesUnavailable":
    "Aptiloop could not check the local Course library. Retry before creating or selecting a Course.",
  "home.noCourses.title": "Create your first Course",
  ...
  "home.noCourse.description":
    "Choose one of your local Courses, create another one, or import a validated Course Pack to begin.",
  ...
  "time.estimated": "About {duration}",
  "time.estimatedRemaining": "About {duration} remaining",
  ...
  "settings.section.aiDescription":
    "Choose one exact available connection and model, or keep AI Off. Aptiloop tests it on first use and never falls back to Mock.",
  ...
  "settings.connection.removing": "Removing…",
  "settings.connection.removeTitle": "Remove this connection?",
  "settings.connection.removeDescription":
    "Its credentials and local configuration will be removed. Assigned AI roles will turn off, while existing history is retained.",
  "settings.connection.removeConfirm": "Remove connection",
  "settings.connection.removeSuccess": "Connection removed",
  ...
  "provider.off": "AI Off",
  "provider.configured": "AI configured",
  ...
  "provider.degradedNotice":
    "This connection is configured and can be used. Aptiloop will test it when you make the first request.",
  ...
  "review.activity.start": "Start review",
  "review.activity.unavailableShort": "Review activity unavailable",
  "review.activity.back": "Return to review queue",
  "review.activity.badge": "Spaced review",
  "review.activity.statusDue": "Due now",
  "review.activity.promptHeading": "Review prompt",
  "review.activity.responseLabel": "Your response",
  "review.activity.responseHint":
    "Answer from memory in your own words. Submitting records new learner evidence.",
  "review.activity.responsePlaceholder": "Write your response…",
  "review.activity.characters": "{count} of {maximum} characters",
  "review.activity.submit": "Complete review",
  "review.activity.submitting": "Completing review…",
  "review.activity.loading": "Loading review activity…",
  "review.activity.unavailableTitle": "Review activity unavailable",
  "review.activity.unavailableDescription":
    "This review activity may no longer be due or its saved snapshot may be unavailable. Return to the queue or retry the exact activity.",
  "review.activity.invalidResponse": "Write a response before submitting.",
  "review.activity.submitError": "The review was not completed.",
  "review.activity.submitErrorDescription":
    "Your response is still here. Submit it again to safely retry, or edit it before trying again.",
  "review.activity.complete": "Review completed",
  "review.activity.nextDue": "Next review: {date}",
  "review.activity.metadata.due": "Due date",
  "review.activity.metadata.sourceEvidence": "Source evidence recorded",
  "review.activity.metadata.sourceActivity": "Source activity",
  "review.activity.metadata.dimension": "Skill dimension",
  ...
  "session.transition.meta.one": "{name} · {count} activity",
  "session.transition.meta.other": "{name} · {count} activities",
  ...
  "session.activitiesCount.one": "{count} activity",
  "session.activitiesCount.other": "{count} activities",
  ...
  "courses.library.empty.description":
    "Aptiloop intentionally starts without bundled Courses. Create your own Course locally, or import a JSON Course Pack you trust.",
...
const ruRU: Record<MessageKey, string> = {
  ...
  "home.loadingCourses": "Проверяю локальные курсы…",
  "home.unavailable": "Aptiloop Core недоступен.",
  "home.coursesUnavailable":
    "Aptiloop не смог проверить локальную библиотеку курсов. Повторите попытку перед созданием или выбором курса.",
  "home.noCourses.title": "Создайте свой первый курс",
  "home.noCourses.description":
    "Aptiloop устанавливается без готовых курсов. Создайте собственный курс локально или импортируйте Course Pack, которому доверяете.",
  "home.noCourse.title": "Нет активного курса",
  "home.noCourse.description":
    "Выберите один из локальных курсов, создайте ещё один или импортируйте проверенный Course Pack, чтобы начать.",
  ...
  "time.estimated": "Примерно {duration}",
  "time.estimatedRemaining": "Осталось примерно {duration}",
  ...
  "settings.section.aiDescription":
    "Выберите одно точное доступное подключение и модель или оставьте AI выключенным. Aptiloop проверит его при первом запросе и не подменит на Mock.",
  ...
  "settings.connection.remove": "Удалить подключение",
  "settings.connection.removing": "Удаляю…",
  "settings.connection.removeTitle": "Удалить это подключение?",
  "settings.connection.removeDescription":
    "Учётные данные и локальная конфигурация будут удалены. Назначенные AI-роли выключатся, а существующая история сохранится.",
  "settings.connection.removeConfirm": "Удалить подключение",
  "settings.connection.removeSuccess": "Подключение удалено",
  "settings.connection.removeActiveRequest":
  ...
  "provider.configured": "AI настроен",
  ...
  "provider.degradedNotice":
    "Подключение настроено и доступно для работы. Aptiloop проверит его при первом запросе.",
  ...
  "review.activity.start": "Начать повторение",
  "review.activity.unavailableShort": "Активность повторения недоступна",
  "review.activity.back": "Вернуться к очереди",
  "review.activity.badge": "Интервальное повторение",
  "review.activity.statusDue": "Назначено сейчас",
  "review.activity.promptHeading": "Задание для повторения",
  "review.activity.responseLabel": "Ваш ответ",
  "review.activity.responseHint":
    "Ответьте по памяти своими словами. После отправки появится новое учебное подтверждение.",
  "review.activity.responsePlaceholder": "Напишите свой ответ…",
  "review.activity.characters": "{count} из {maximum} символов",
  "review.activity.submit": "Завершить повторение",
  "review.activity.submitting": "Завершаю повторение…",
  "review.activity.loading": "Загружаю активность повторения…",
  "review.activity.unavailableTitle": "Активность повторения недоступна",
  "review.activity.unavailableDescription":
    "Возможно, это повторение уже не назначено или его сохранённый snapshot недоступен. Вернитесь к очереди либо повторите загрузку этой активности.",
  "review.activity.invalidResponse": "Напишите ответ перед отправкой.",
  "review.activity.submitError": "Не удалось завершить повторение.",
  "review.activity.submitErrorDescription":
    "Ваш ответ сохранён на экране. Отправьте его снова для безопасного повтора либо отредактируйте перед следующей попыткой.",
  "review.activity.complete": "Повторение завершено",
  "review.activity.nextDue": "Следующее повторение: {date}",
  "review.activity.metadata.due": "Срок",
  "review.activity.metadata.sourceEvidence": "Исходное подтверждение записано",
  "review.activity.metadata.sourceActivity": "Исходная активность",
  "review.activity.metadata.dimension": "Измерение навыка",
  ...
  "session.transition.meta.one": "{name} · Активность: {count}",
  "session.transition.meta.other": "{name} · Активностей: {count}",
  ...
  "session.activitiesCount.one": "Активность: {count}",
  "session.activitiesCount.other": "Активностей: {count}",
  "session.briefing.skipDescription":
