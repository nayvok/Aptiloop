  ...
  return (
    ...
    >
      ...
      <header
        ...
        className="flex min-w-0 flex-col gap-2.5 sm:flex-row sm:items-start sm:justify-between"
      >
      ...
      <div data-slot="activity-content" className="min-w-0 pb-1 pt-6">
        {children}
      </div>
      {slots.runtime ? (
        <div
          data-slot="activity-runtime"
          className="mb-5 min-w-0 rounded-focus bg-surface-soft/60 px-4 py-4 sm:px-5"
        >
          {slots.runtime}
        </div>
      ) : null}
      {slots.evidence ? (
        <div
          ...
          className="mb-5 min-w-0 rounded-focus bg-surface-soft/45 px-4 py-4 sm:px-5"
        >
          {slots.evidence}
        </div>
      ) : null}
      {slots.actions ? (
        <footer data-slot="activity-actions" className="mb-5 min-w-0 pt-1">
          {slots.actions}
        </footer>
      ) : null}
    </section>
