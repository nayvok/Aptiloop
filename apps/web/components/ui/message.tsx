...
function MessageFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex max-w-full min-w-0 items-center px-3 text-xs text-muted-foreground group-data-[align=end]/message:justify-end group-has-[[data-variant=ghost]]/message:px-0",
        className,
      )}
      {...props}
    />
